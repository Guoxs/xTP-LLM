...
class DataTrainingArguments:
    ...
    project_name: Optional[str] = field(
        default=None, metadata={"help": "The name of this project."}
    )
    
    experiment_id: Optional[str] = field(
        default=None, metadata={"help": "A specific experiment id for evaluate."} 
    )
...
def main():
    ...
    if training_args.do_eval:
        ...
        metric = evaluate.load("accuracy.py", experiment_id=data_args.experiment_id)
